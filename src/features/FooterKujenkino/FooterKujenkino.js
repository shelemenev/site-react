function FooterKujenkino() {

  return (
    <>
	    <div className="row kick space-between hidden">
		    <a className='down' href='places.html'><img src="images/back.png" /></a>
		    <div className="goup"><img className='down' src="images/up.png" /></div>
		  </div>
		  <div className="row kick space-between hidden_mobile">
		    <div className="category big"><a className='color' href='places.html'>Назад</a></div>
